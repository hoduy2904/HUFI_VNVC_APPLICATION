...
class FormInputStatus extends ProfileState {
  ...
  String? get validateFullName => fullName == null || fullName!.length < 6
      ? "Vui lòng nhập hơn 6 ký tự"
      : null;
  ...
  String? get validateInsuranceCode =>
      insuranceCode == null || insuranceCode!.length < 5
          ? "Vui lòng nhập mã thẻ BHYT"
          : null;
  final String? email;
  final String? identityCode;
  String? get validateIdentityCode =>
      identityCode == null || identityCode!.length < 8
          ? "Vui lòng nhập CCCD/CMND hợp lệ"
          : null;
  final String? address;
  String? get validateAddress => address == null || address!.length < 5
